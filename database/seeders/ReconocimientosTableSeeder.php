...
class ReconocimientosTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach (self::$arrayReconocimientos as $reconocimiento) {
            $r = new Reconocimiento;
            $r->estudiante_id = $reconocimiento['estudiante_id'];
            $r->actividad_id = $reconocimiento['actividad_id'];
            $r->documento = $reconocimiento['documento'];
            $r->docente_validador = $reconocimiento['docente_validador'];
            $r->save();
        }
    }
